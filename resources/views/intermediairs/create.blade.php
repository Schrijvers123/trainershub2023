    ...
    <div class="space-y-6 sm:px-6 lg:col-span-9 lg:px-0">
                ...
                <div class="shadow sm:overflow-hidden sm:rounded-md">
                    <div class="space-y-6 bg-white px-4 py-6 sm:p-6">
                        <div class="border-b border-gray-900/10 pb-12">
                            <h2 class="text-base font-semibold leading-7 text-gray-900">Intermediairgegevens</h2>
                            <p class="mt-1 text-sm leading-6 text-gray-600"Vul onderstaande gegevens in om een nieuwe intermediair toe te voegen</p>
        ...
        <form action="#" method="POST">
            <div class="shadow sm:overflow-hidden sm:rounded-md">
                <div class="space-y-6 bg-white px-4 py-6 sm:p-6">
                    <div>
                        <h3 class="text-base font-semibold leading-6 text-gray-900">Intermediair data</h3>
                        <p class="mt-1 text-sm text-gray-500">Fill the fields below in enter a new Intermediair</p>
                    </div>
